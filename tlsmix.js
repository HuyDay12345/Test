const net = require("net");
 ...
 if (process.argv.length < 7){console.log(`node tlsmix target time rate thread proxyfile`); process.exit();}
 const headers = {};
...
'ECDHE-RSA-AES256-SHA:AES256-SHA:HIGH:!AESGCM:!CAMELLIA:!3DES:!EDH'
 ...
 const uap = [
     ...
     "Mozilla/5.0 (Linux; Android 10; Elite P55) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.82 Mobile Safari/537.36",
     "Mozilla/5.0 (Windows; U; Windows NT 6.0) AppleWebKit/532.0.0 (KHTML, like Gecko) Chrome/18.0.862.0 Safari/532.0.0",
     "Mozilla/5.0 (Windows; U; Windows NT 6.0) AppleWebKit/531.0.2 (KHTML, like Gecko) Chrome/19.0.852.0 Safari/531.0.2",
     "Mozilla/5.0 (Windows; U; Windows NT 5.2) AppleWebKit/535.2.0 (KHTML, like Gecko) Chrome/15.0.897.0 Safari/535.2.0",
     "Mozilla/5.0 (compatible; MSIE 7.0; Windows NT 6.1; Trident/3.1; .NET CLR 2.2.50003.9)",
     "Mozilla/5.0 (Windows NT 5.0; WOW64; rv:11.5) Gecko/20100101 Firefox/11.5.9",
     "Mozilla/5.0 (Macintosh; Intel Mac OS X 10.8.0; rv:12.5) Gecko/20100101 Firefox/12.5.6",
     "Mozilla/5.0 (Windows; U; Windows NT 5.2) AppleWebKit/532.1.2 (KHTML, like Gecko) Chrome/15.0.868.0 Safari/532.1.2",
     "Mozilla/5.0 (Windows; U; Windows NT 6.2) AppleWebKit/533.1.2 (KHTML, like Gecko) Chrome/26.0.865.0 Safari/533.1.2",
     "Mozilla/5.0 (Windows NT 5.0; WOW64; rv:13.7) Gecko/20100101 Firefox/13.7.1",
     "Mozilla/5.0 (compatible; MSIE 8.0; Windows NT 6.3; Trident/5.0; .NET CLR 1.9.79511.0)",
     "Mozilla/5.0 (Windows NT 6.2; rv:10.9) Gecko/20100101 Firefox/10.9.5",
     "Mozilla/5.0 (Windows NT 6.2; Win64; x64; rv:7.2) Gecko/20100101 Firefox/7.2.3",
     "Mozilla/5.0 (Windows; U; Windows NT 5.0) AppleWebKit/537.1.1 (KHTML, like Gecko) Chrome/15.0.867.0 Safari/537.1.1",
     "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_6_2 rv:3.0; SV) AppleWebKit/532.1.0 (KHTML, like Gecko) Version/7.0.5 Safari/532.1.0",
     "Mozilla/5.0 (Windows; U; Windows NT 6.2) AppleWebKit/538.2.2 (KHTML, like Gecko) Chrome/22.0.842.0 Safari/538.2.2",
     "Mozilla/5.0 (Windows; U; Windows NT 5.0) AppleWebKit/533.0.0 (KHTML, like Gecko) Chrome/32.0.874.0 Safari/533.0.0",
     "Mozilla/5.0 (Windows; U; Windows NT 5.3) AppleWebKit/531.0.1 (KHTML, like Gecko) Chrome/27.0.828.0 Safari/531.0.1",
     "Mozilla/5.0 (Windows; U; Windows NT 6.2) AppleWebKit/538.0.2 (KHTML, like Gecko) Chrome/33.0.882.0 Safari/538.0.2",
     "Mozilla/5.0 (Windows; U; Windows NT 6.0) AppleWebKit/537.0.0 (KHTML, like Gecko) Chrome/37.0.881.0 Safari/537.0.0",
     "Mozilla/5.0 (Windows NT 6.2; rv:8.3) Gecko/20100101 Firefox/8.3.4",
     "Mozilla/5.0 (Windows; U; Windows NT 6.0) AppleWebKit/532.2.2 (KHTML, like Gecko) Chrome/35.0.881.0 Safari/532.2.2",
     "Mozilla/5.0 (Windows NT 6.2; rv:6.7) Gecko/20100101 Firefox/6.7.7",
     "Mozilla/5.0 (compatible; MSIE 8.0; Windows NT 6.2; Trident/6.0; .NET CLR 4.3.31570.6)",
     "Mozilla/5.0 (Windows; U; Windows NT 5.2) AppleWebKit/538.0.0 (KHTML, like Gecko) Chrome/13.0.861.0 Safari/538.0.0",
     "Mozilla/5.0 (Windows; U; Windows NT 5.3) AppleWebKit/538.0.0 (KHTML, like Gecko) Chrome/26.0.893.0 Safari/538.0.0",
     "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_7_1) AppleWebKit/534.2.0 (KHTML, like Gecko) Chrome/26.0.804.0 Safari/534.2.0",
     "Mozilla/5.0 (Windows NT 6.1; rv:10.9) Gecko/20100101 Firefox/10.9.6",
     "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_5) AppleWebKit/533.2.1 (KHTML, like Gecko) Chrome/24.0.809.0 Safari/533.2.1",
     "Mozilla/5.0 (Windows NT 6.3; Win64; x64; rv:8.1) Gecko/20100101 Firefox/8.1.7",
     "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_6_0 rv:4.0; BG) AppleWebKit/534.1.2 (KHTML, like Gecko) Version/7.1.7 Safari/534.1.2",
     "Mozilla/5.0 (Windows; U; Windows NT 5.3) AppleWebKit/535.0.0 (KHTML, like Gecko) Chrome/13.0.868.0 Safari/535.0.0",
     "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_5_6) AppleWebKit/537.1.1 (KHTML, like Gecko) Chrome/17.0.806.0 Safari/537.1.1",
     "Mozilla/5.0 (Windows NT 6.0; rv:9.6) Gecko/20100101 Firefox/9.6.9",
     "Mozilla/5.0 (Windows; U; Windows NT 6.1) AppleWebKit/538.0.2 (KHTML, like Gecko) Chrome/31.0.853.0 Safari/538.0.2",
     "Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 5.0; Trident/6.0; .NET CLR 1.4.85781.2)",
     "Mozilla/5.0 (Windows; U; Windows NT 5.3) AppleWebKit/533.0.0 (KHTML, like Gecko) Chrome/32.0.822.0 Safari/533.0.0",
     "Mozilla/5.0 (Windows; U; Windows NT 6.2) AppleWebKit/533.1.1 (KHTML, like Gecko) Chrome/18.0.847.0 Safari/533.1.1",
     "Mozilla/5.0 (Windows; U; Windows NT 6.3) AppleWebKit/531.0.2 (KHTML, like Gecko) Chrome/21.0.848.0 Safari/531.0.2",
...
headers[':scheme'] = 'https';
headers.Referer = 'https://google.com','https://www.facebook.com','https://www.youtube.com', 'https://www.roblox.com', 'https://www.google.com.vn', 'https://translate.google.com', 'https://about.google', 'https://vi.wikipedia.org', 'https://apps.apple.com';
...
headers.pragma = 'no-cache',"max-age=0";
